...
# Nautica Proxy Server - V2 Installer (Correct Format)
# Author: AI Assistant
# Version: 3.0 - Correct Proxy Format
...
echo -e "${BLUE}"
echo "================================================"
echo "  NAUTICA PROXY SERVER - V2 INSTALLER"
echo "================================================"
echo -e "${NC}"
...
{
  "name": "nautica-proxy-server-v2",
  "version": "3.0.0",
  "description": "Nautica Proxy Server V2 with Correct Format",
  "main": "server.js",
  "scripts": {
...
# Create server.js with correct proxy format
echo -e "${BLUE}📄 Creating server.js with correct proxy format...${NC}"
cat > server.js << 'EOF'
...
echo -e "${BLUE}📄 Creating web dashboard with correct proxy format...${NC}"
mkdir -p public
...
<head>
    ...
    <title>Nautica Proxy Server V2 - Dashboard</title>
    ...
    <header class="gradient-bg text-white shadow-lg">
        <div class="container mx-auto px-6 py-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold">🌊 Nautica Proxy Server V2</h1>
                    <p class="text-blue-100 mt-2">Correct Proxy Format Dashboard</p>
                </div>
                    ...
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <div class="flex space-x-2">
                            <button onclick="showConfigs('${account.id}')" 
                                class="copy-btn bg-blue-600 text-white px-3 py-1 rounded text-sm hover:bg-blue-700">
...
module.exports = {
  apps: [{
    ...
    log_file: '/opt/nautica-proxy-v2/logs/combined.log',
    out_file: '/opt/nautica-proxy-v2/logs/out.log',
    error_file: '/opt/nautica-proxy-v2/logs/error.log'
  }]
}
EOF
...
echo -e "${BLUE}"
echo "================================================"
echo "  🎉 V2 INSTALLATION COMPLETED SUCCESSFULLY!"
echo "================================================"
echo -e "${NC}"
echo ""
...
echo -e "   View Logs: ${YELLOW}pm2 logs nautica-proxy-v2${NC}"
echo -e "   Restart: ${YELLOW}pm2 restart nautica-proxy-v2${NC}"
echo -e "   Status: ${YELLOW}pm2 status${NC}"
echo -e "   Stop: ${YELLOW}pm2 stop nautica-proxy-v2${NC}"
echo ""
echo -e "${CYAN}✨ V2 Features:${NC}"
echo -e "   • Correct proxy format (matching _worker.js)"
echo -e "   • VLESS, Trojan, Shadowsocks support"
echo -e "   • Proxy server selection"
...
echo ""
echo -e "${GREEN}🚀 Your Nautica Proxy Server V2 is ready!${NC}"
echo -e "${YELLOW}Open your browser and visit: $PROTOCOL://$DOMAIN/${NC}"
echo ""
echo -e "${CYAN}📝 Note:${NC}"
echo -e "   This is a NEW installation (V2) that doesn't affect your existing V1 dashboard"
echo -e "   Both can run simultaneously on different ports if needed"
echo ""
