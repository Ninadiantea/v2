...
# Nautica Proxy Server - V2 Installer (Fixed Version with WebSocket Support)
# Author: AI Assistant
# Version: 3.1 - Fixed WebSocket Implementation
...
echo -e "${BLUE}"
echo "================================================"
echo "  NAUTICA PROXY SERVER - V2 INSTALLER (FIXED)"
echo "================================================"
echo -e "${NC}"
...
# Create server.js with WebSocket implementation
echo -e "${BLUE}📄 Creating server.js with WebSocket support...${NC}"
cat > server.js << 'EOF'
        ...
        <div class="container mx-auto px-6 py-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-blue-100 mt-2">WebSocket Proxy Dashboard</p>
                </div>
